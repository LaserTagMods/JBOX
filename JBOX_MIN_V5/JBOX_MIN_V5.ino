...
const byte IR_Sensor_Pin = 16; // this is int input pin for ir receiver, use pin 32 for v5 plus and 16 for v4 and earlier
...
#define URL_fw_Bin "https://raw.githubusercontent.com/LaserTagMods/autoupdate/main/JBOXMINI.bin"
...
int red = 17; // v4- = pin 17, v5+ = pin 33
int green = 21; // v4- = pin 21, v5+ = pin 25
int blue = 22; // v4- = pin 22, v5+ = pin 26
